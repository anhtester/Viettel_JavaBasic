...
public class KieuDuLieu1 {
    public static void main(String[] args) {
        ...
        int number3 = 2084891090;

        long number4 = 1234567890123453425L;

        float number5 = 122954655.28945846982335904985356F;

        double number6 = 2846295412894963905739474937629D;
